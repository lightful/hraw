# "Universal C++ POSIX Makefile" v2.3 for GNU make

#       Copyright Ciriaco Garcia de Celis 2011-2017.
...
#         SUBPRJS   := ../Lib1 ../Lib2  # to be built before this project (each require its own Makefile)
...
#         SUBLIBS   := ../Lib1 ../Lib2  # to be included
...
INCLUDES := $(foreach dir,$(SUBPRJS) $(SUBLIBS),-I$(dir)/include) $(INCLUDES)
LIBS     := $(foreach dir,$(SUBPRJS),$(wildcard $(dir)/$(BUILD_DIR)/*.a)) $(LIBS)
DEPLIBS  := $(foreach dir,$(SUBPRJS) $(SUBLIBS),$(wildcard $(dir)/$(BUILD_DIR)/*.a))
...
all:: $(DEPLIBS) checkdirs $(PATH_BIN) $(PATH_LIB)
